...
const StartupForm = () => {
    ...
    const handleFormSubmit = async (prevState:any, formData: FormData) => {
        try{
            ...
            toast({
                title: "Error",
                description: "An unexpected errror has occured",
                variant: "destructive",
            });
        }
    }
    ...
    return (
        <form action={formAction} className="startup-form">
            ...
            <div>
                ...
                <Input id="category" name="category" className="startup-form_input" required placeholder="Startup Category (Tech, Health, Eductaion...)"/>
            ...
            <Button type="submit" className="startup-form_btn" disabled={isPending}>{isPending?"Submitting....":"Submit your form"}
